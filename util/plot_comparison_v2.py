...
# Gpuff 데이터 (Bq*s/m3) - 첫 번째 값 제외, 10km까지만 (B, C, D, E만) - 업데이트된 값
gpuff = {
    'B': [1.86E-03, 5.80E-04, 2.26E-04, 1.02E-04, 4.75E-05, 2.25E-05, 1.08E-05, 6.15E-06, 4.68E-06, 3.71E-06, 2.98E-06, 1.98E-06, 1.42E-06, 1.07E-06],
    'C': [1.31E-03, 5.80E-04, 2.99E-04, 1.71E-04, 1.00E-04, 5.94E-05, 3.53E-05, 2.10E-05, 1.31E-05, 8.30E-06, 5.44E-06, 3.38E-06, 2.33E-06, 1.80E-06],
    'D': [3.66E-03, 1.78E-03, 9.90E-04, 6.05E-04, 3.76E-04, 2.36E-04, 1.49E-04, 9.43E-05, 6.18E-05, 4.14E-05, 2.84E-05, 1.37E-05, 7.55E-06, 4.63E-06],
    'E': [5.10E-03, 2.54E-03, 1.44E-03, 8.93E-04, 5.64E-04, 3.60E-04, 2.31E-04, 1.48E-04, 9.84E-05, 6.68E-05, 4.63E-05, 3.09E-05, 2.13E-05, 1.53E-05]
}
...
for idx, sc in enumerate(stability_classes):
    ...
    # Gpuff 데이터 (점선)
    ax.loglog(distances, gpuff[sc], 's--', color=colors[sc], label='Gpuff', linewidth=2, markersize=5, alpha=0.7)
...
plt.suptitle('RCAP vs Gpuff: Time-Integrated Concentration (with Ground Reflection)', fontsize=14, fontweight='bold', y=1.02)
plt.tight_layout()
plt.savefig('X:/code/gpuffv4/gpuff-RCAPv3/util/comparison_plot_v2.png', dpi=150, bbox_inches='tight')
print("Plot 1 saved to: X:/code/gpuffv4/gpuff-RCAPv3/util/comparison_plot_v2.png")
...
ax2.set_title('RCAP vs Gpuff: Time-Integrated Concentration (with Ground Reflection)', fontsize=14, fontweight='bold')
ax2.legend(loc='upper right', fontsize=9, ncol=2)
ax2.grid(True, which='both', alpha=0.3)
ax2.set_xlim([0.15, 12])

plt.tight_layout()
plt.savefig('X:/code/gpuffv4/gpuff-RCAPv3/util/comparison_plot_all_v2.png', dpi=150, bbox_inches='tight')
print("Plot 2 saved to: X:/code/gpuffv4/gpuff-RCAPv3/util/comparison_plot_all_v2.png")
