// ====================================================================================
// GPUFF-RCAPv3 CUDA Kernel Constants and Helper Functions
// ====================================================================================
//
// File: gpuff_kernels_constants.cuh
// Purpose: Constants, device variables, and inline helper functions for GPU kernels
//
// This file contains:
//   - Physical constants and model parameters
//   - Dispersion coefficient calculations (Pasquill-Gifford & Briggs-McElroy-Pooler)
//   - Atomic operations for floating-point values
//   - Newton-Raphson iteration methods
//
// ====================================================================================

#ifndef GPUFF_KERNELS_CONSTANTS_CUH
#define GPUFF_KERNELS_CONSTANTS_CUH
 ...
 */
__device__ inline float Sigma_h_Pasquill_Gifford(int PasquillCategory, float virtual_distance) {
 ...
 */
inline float Sigma_h_Pasquill_Gifford_cpu(int PasquillCategory, float virtual_distance) {
    float coefficient0[7] = {-1.104, -1.634, -2.054, -2.555, -2.754, -3.143, -3.143};
    float coefficient1[7] = {0.9878, 1.0350, 1.0231, 1.0423, 1.0106, 1.0418, 1.0418};
    float coefficient2[7] = {-0.0076, -0.0096, -0.0076, -0.0087, -0.0064, -0.0070, -0.0070};
 ...
 */
__device__ inline float dSh_PG(int PasquillCategory, float virtual_distance) {
    float coefficient0[7] = {-1.104, -1.634, -2.054, -2.555, -2.754, -3.143, -3.143};
    float coefficient1[7] = {0.9878, 1.0350, 1.0231, 1.0423, 1.0106, 1.0418, 1.0418};
    float coefficient2[7] = {-0.0076, -0.0096, -0.0076, -0.0087, -0.0064, -0.0070, -0.0070};
 ...
 */
__device__ inline float Sigma_z_Pasquill_Gifford(int PasquillCategory, float virtual_distance) {
 ...
 * Identical formula to device version, for validation and debugging
 */
inline float Sigma_z_Pasquill_Gifford_cpu(int PasquillCategory, float virtual_distance) {
    float coefficient0[7] = {4.679, -1.999, -2.341, -3.186, -3.783, -4.490, -4.490};
    float coefficient1[7] = {-1.172, 0.8752, 0.9477, 1.1737, 1.3010, 1.4024, 1.4024};
    float coefficient2[7] = {0.2770, 0.0136, -0.0020, -0.0316, -0.0450, -0.0540, -0.0540};
 ...
 */
__device__ inline float dSz_PG(int PasquillCategory, float virtual_distance) {
    float coefficient0[7] = {4.679, -1.999, -2.341, -3.186, -3.783, -4.490, -4.490};
    float coefficient1[7] = {-1.172, 0.8752, 0.9477, 1.1737, 1.3010, 1.4024, 1.4024};
    float coefficient2[7] = {0.2770, 0.0136, -0.0020, -0.0316, -0.0450, -0.0540, -0.0540};
 ...
 * @return Vertical dispersion parameter sigma_z (meters)
 */
__device__ inline float Sigma_z_Briggs_McElroy_Pooler(int PasquillCategory, float virtual_distance) {
 ...
 */
__device__ inline float dSz_BMP(int PasquillCategory, float virtual_distance) {
    float coefficient0_rural[7] = {0.20, 0.12, 0.08, 0.06, 0.03, 0.016, 0.016};
    float coefficient1_rural[7] = {0.0, 0.0, 0.0002, 0.0015, 0.0003, 0.0003, 0.0003};
    float coefficient2_rural[7] = {1.0, 1.0, -0.5, -0.5, -1.0, -1.0, -1.0};
 ...
 */
__device__ inline float NewtonRaphson_h(int PasquillCategory, float targetSigma, float init) {
    float x = init;
    float fx, dfx;
 ...
 * @return Calculated virtual distance (meters)
 */
__device__ inline float NewtonRaphson_z(int PasquillCategory, float targetSigma, float init) {
    float x = init;
    float fx, dfx;
...
#endif // GPUFF_KERNELS_CONSTANTS_CUH